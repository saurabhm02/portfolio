const Button = ({ btnText, btnIcon = null,handleOnClick }) => {
  return (
    <button className="relative inline-block text-lg group" onClick={handleOnClick}>
      <span className="relative z-10 block px-3 py-3 overflow-hidden font-medium leading-tight text-fadeMainTheme transition-colors duration-300 ease-out border-2 border-fadeMainTheme rounded-lg group-hover:text-white">
